...
class PortfolioApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    Widget titleSection = new Container(
      ...
      child: new Row(
        children: [
          new Expanded(
            ...
            children: <Widget>[
              new Container(
                ...
                child: new Text('Zuri second flutter assignment',
                    style: new TextStyle(
                        fontWeight: FontWeight.bold, fontSize: 20.0)),
              ),
              new Text('With all honesty programming is time consuming',
                  style: new TextStyle(color: Colors.grey[600], fontSize: 18.0))
            ],
          )),
          new Text('Likes', style: new TextStyle(fontSize: 10.0)),
          new Icon(
            Icons.favorite,
            color: Colors.red,
          ),
          ...
          new Text('Notifications', style: new TextStyle(fontSize: 10.0)),
          new Icon(
    ...
    Widget sixButtonsSection = new Container(
        child: new Row(
      ...
      children: <Widget>[
        ...
        buildButton(Icons.email, 'E-mail'),
